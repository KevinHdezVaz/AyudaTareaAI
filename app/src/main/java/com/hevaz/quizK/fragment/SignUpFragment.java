...
import com.hevaz.quizK.activity.LoginTabActivity;
...
// En el método onClick del botón de registro dentro de onCreateView
        signupryt.setOnClickListener(view -> {
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(getActivity(), task -> {
                hideProgressDialog(); // Asegurarse de ocultar el ProgressDialog independientemente del resultado
