package com.hevaz.quizK.ayudaia.intro
...
import com.hevaz.quizK.databinding.FragmentIntroBinding
...
class IntroFragment: Fragment() {
    ...
    private fun isFirstTime(context: Context): Boolean {
        val preferences = context.getSharedPreferences("myPreferencesFile", Context.MODE_PRIVATE)
