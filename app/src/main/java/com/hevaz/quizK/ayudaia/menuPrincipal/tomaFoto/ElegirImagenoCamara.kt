...
import com.hevaz.quizK.databinding.ExtendedActivityBinding
import timber.log.Timber

internal class ElegirImagenoCamara : CropImageActivity() {

    companion object {
        fun start(activity: Activity) {
            ActivityCompat.startActivity(
                activity,
                Intent(activity, ElegirImagenoCamara::class.java),
                null,
            )
        }
    }
